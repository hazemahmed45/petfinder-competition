...
model.load_state_dict(torch.load('exp/46/pawpularity_swin_withmeta_withconfbar_46.pt'))
model.eval()
...
dataset_splitter=PawpularityClassificationWithBinsConfBarDatasetSplitter(img_dir=IMG_DIR,meta_csv=IMG_META_DIR,transforms_dict=transform_dict,bin_increment=5)
