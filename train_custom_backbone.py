...
MODEL_NAME='pawpularity_custom_'+str(EXP_NUM)+'.pt'
...
wandb.init(name='pawpularity-regressor-custom-'+str(EXP_NUM),config=config,job_type='classification',project="pawpularity-regression", entity="hazem45")
transform_dict={
...
backone=CustomClassifierBackBone(input_size=IMG_HEIGHT)
