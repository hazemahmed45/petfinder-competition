...
from model import Resnet18PawpularityClassifier,Resnet18WithMetaPawpularityClassifier
...
model=Resnet18PawpularityClassifier(backbone_weights=BACKBONE_WEIGHTS)
model.to(device)
