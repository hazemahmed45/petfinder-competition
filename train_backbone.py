...
from dataloaders.regression_dataloader import DogCatDataset
...
dataset=DogCatDataset(dataset_dir=IMG_DIR,transforms=transform_dict['train'])
# train_dataset,valid_dataset=next(iter(dataset_splitter.generate_train_valid_dataset(TRAIN_SPLIT)))

train_loader=DataLoader(dataset=dataset,batch_size=BATCH_SIZE,shuffle=SHUFFLE,num_workers=NUM_WORKERS,pin_memory=PIN_MEMORY)
