...
from model import MobileNetV3WithMetaWithConfidenceBarPawpularityClassifier
...
BACKBONE_WEIGHTS='checkpoints/pawpularity_inceptionv3_backbone_1.pt'
...
model=MobileNetV3WithMetaWithConfidenceBarPawpularityClassifier(backbone_weights=None)
# model.load_state_dict(torch.load('checkpoints/pawpularity_inceptionv3_0.pt'))
model.to(device)
